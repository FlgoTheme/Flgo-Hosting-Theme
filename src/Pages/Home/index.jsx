...
export default function Home() {
    return (
            ...
            <div className="absolute flex mt-2 md:mt-36 text-white text-center justify-center w-full items-center bg-no-repeat h-[500px] md:h-[600px] bg-transparent bg-center bg-[url('https://cdn.discordapp.com/attachments/1152668559168782479/1160650334994169936/background.png?ex=65356edb&is=6522f9db&hm=f3b8849c478886b2b3638837b167959b26976e556342b60933499aef364a1b9b&')]">
                  <div>
                     ...
                     <p className="font-medium text-sm md:text-base text-[#9CA3AF] mt-2">Last beta application date is 1.3.2024</p>
